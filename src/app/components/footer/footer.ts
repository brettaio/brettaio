...
@Component({
  selector: 'bretta-footer',
  imports: [],
  template: ` <footer class="bg-[#14081f]">
  <div class="mx-auto max-w-7xl overflow-hidden px-6 py-6">
    ...
    <p class="text-center text-sm/6 text-gray-400">&copy; 2026 Bretta Etc Ltd. All rights reserved.</p>
    <p class="text-center text-sm/6 text-gray-400">[-o-] Always Was. Always Will Be. [-o-]</p>
  </div>
</footer>
 `,
  styles: ``,
