...
@Component({
  selector: 'bretta-hero-alt',
  template: `
    <!--
      ALT HERO SECTION

      Same structure as the primary hero:
      canvas background, overlays, then content on top.
    -->
    <section class="relative isolate overflow-hidden bg-black text-white">
      ...
      <!--
        50% black intensity wash
        This is the main control for calming the shader down.
      -->
      <div class="absolute inset-0 bg-black/50"></div>

      <!-- Secondary gradient shaping -->
      <div
...
export class HeroAlt implements AfterViewInit {
  ...
  private startShader(): void {
    ...
    const fragmentShaderSource = `
      ...
      void main() {
        ...
        vec4 color = tanhApprox(o / 6e6 / max(d, 0.001));
