...
export const jimbosPub: RestaurantSiteInput = {
  ...
  pageCopy: {
    ...
    featuredEyebrow: 'At the pub',
    featuredTitle: 'Wings, specials, patio nights.',
    featuredDescription:
      'Start with what makes the place a regular stop, then move into the full food menu, VIP list, and private room details.',
    venueEyebrow: 'More to know',
    venueTitle: 'A proper neighbourhood pub setup.',
    venueDescription:
      'Sports, patio seating, karaoke, free parking, and group-friendly tables all stay easy to find on one page.',
    menuEyebrow: 'Menu',
    menuTitle: 'Pub favourites.\nFull menu.',
    menuDescription:
      'Daily specials, fresh wings, loaded starters, wraps, burgers, mains, sandwiches, and late dinner staples are all visible on-page.',
    highlightsEyebrow: 'Why people come back',
    visitEyebrow: 'Visit',
